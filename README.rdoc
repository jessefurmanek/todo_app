...
This is a basic Rails Todo application with an API that (hopefully) satisfies the following requirements:
...
In addition, the app should meet the following requirements:
...
Look to sample_requests.txt for example API calls.
